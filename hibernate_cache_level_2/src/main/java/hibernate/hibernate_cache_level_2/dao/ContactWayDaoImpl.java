...
@Repository
public class ContactWayDaoImpl extends BaseDaoImpl<ContactWay> implements ContactWayDao  {
	public ContactWayDaoImpl(){
		super(ContactWay.class);
	}
	
	public List<String> findProperty(String hql){
	...
	public List<ContactWay> queryUser(String openid, String date) { 
		...
		q.setParameter(2, date);
		 List<ContactWay> list=q.getResultList();
